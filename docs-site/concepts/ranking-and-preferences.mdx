...
El Gateway no hardcodea “prioridad por colección” ni sinónimos de un vertical. **La política vive en el mapping** de cada fuente: tú decides si categoría, marca, colección, ubicación, etc. **excluye**, **prioriza** o **solo aporta señal léxica**.
...
- Cambiar sinónimos o `searchWeight` ⇒ nueva versión de mapping + **reindex**.

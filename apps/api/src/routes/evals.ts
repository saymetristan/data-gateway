  ...
  routes.get('/sets/:id', requireScope('evals:read'), async (c) => {
    ...
    return c.json({
      ...
      cases: evalSet.cases.map((evalCase) => ({
        ...
        expectedTopIds: evalCase.expectedTopIds,
        mustRankAbove: evalCase.mustRankAbove,
        mustApplyFilters: evalCase.mustApplyFilters,
        mustApplyPreferences: evalCase.mustApplyPreferences,
        mustNotContainFields: evalCase.mustNotContainFields,
        mustNotAppearInTop: evalCase.mustNotAppearInTop,
        maxResultCount: evalCase.maxResultCount,
        maxConfidence: evalCase.maxConfidence,
        mustContainFields: evalCase.mustContainFields,
    ...
    return c.json(
      {
        ...
        expectedTopIds: created.expectedTopIds,
        mustRankAbove: created.mustRankAbove,
        mustApplyFilters: created.mustApplyFilters,
        mustApplyPreferences: created.mustApplyPreferences,
        mustNotContainFields: created.mustNotContainFields,
        mustNotAppearInTop: created.mustNotAppearInTop,
        maxResultCount: created.maxResultCount,
        maxConfidence: created.maxConfidence,
        mustContainFields: created.mustContainFields,
        createdAt: created.createdAt.toISOString(),
      },
      201,
    );
